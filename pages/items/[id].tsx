  ...
  return (
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="mt-5">
          <h1 className="text-3xl text-gray-900 font-bold">Galaxy S50</h1>
          <span className="text-2xl mt-3 text-gray-900">$140</span>
          <p className="text-base m-6 text-gray-700">
          ...
          <div className="flex items-center justify-between space-x-2">
            ...
            <button className="p-3 flex items-center justify-center text-gray-500 rounded-md hover:bg-gray-100 hover:text-pink-400">
              <svg
                className="h-6 w-6 "
